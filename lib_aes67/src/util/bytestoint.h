...
// Copyright (c) 2018-2019 Nicholas J. Humfrey
...
#define bytesToInt24(a)                                                        \
    (int32_t)(((a)[0] << 24) | ((a)[1] << 16) | ((a)[2] << 8))

// Convert big-endian 32-bit array of bytes to a signed integer
#define bytesToInt32(a)                                                        \
    (int32_t)(((a)[0] << 24) | ((a)[1] << 16) | ((a)[2] << 8) | (a)[3])

// Convert big-endian 32-bit array of bytes to an unsigned integer
#define bytesToUInt32(a)                                                       \
    (uint32_t)(((a)[0] << 24) | ((a)[1] << 16) | ((a)[2] << 8) | (a)[3])
