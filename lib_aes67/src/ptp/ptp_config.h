...
#define PTP_LOG_MIN_DELAY_REQ_INTERVAL (0)
...
#define PTP_DEFAULT_GM_CAPABLE_PRIORITY1                                       \
    (250) // default for portable timeaware-system
...
#define DELAY_REQ_PERIOD LOG_SEC_TO_TIMER_TICKS(PTP_LOG_MIN_DELAY_REQ_INTERVAL)
...
#define RECV_ANNOUNCE_TIMEOUT                                                  \
    (PTP_ANNOUNCE_RECEIPT_TIMEOUT_MULTIPLE * ANNOUNCE_PERIOD)
